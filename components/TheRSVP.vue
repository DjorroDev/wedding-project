...
<template>
  <div
    class="container max-w-4xl px-8 py-10 text-center text-[#2b2b28] bg-[#F9D6AC] mx-4 rounded-2xl h-5/6 my-auto font-desc"
  >
    ...
    <div class="flex flex-col mt-4">
      ...
      <button
        @click="submitHandler"
        class="px-1 py-3 my-10 bg-light shadow-lg w-32 text-[#000] rounded font-heading font-bold text-xl hover:bg-[#d7be96] active:bg-[#c4ad88]"
      >
        Submit
      </button>
